...
class UserSerializer(ModelSerializer):
    class Meta:
        model = User
        fields = ["id","username","phone","email","profile_image","subscription","status","created_at","updated_at"]
...
class UserDetailSerializer(ModelSerializer):
    class Meta:
        model = User
        fields = ['username', 'phone', 'email', 'profile_image', 'subscription', 'status', 'created_at', 'updated_at']
...
class UserUpdateSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ['username', 'phone', 'email', 'subscription', 'status', 'profile_image', 'password']
        extra_kwargs = {
